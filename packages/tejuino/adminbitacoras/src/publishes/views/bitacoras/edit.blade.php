...
<div class="row">
    <div class="col-md-12 p-0">
        ...
        <ol class="breadcrumb pull-right hidden-phone">
            ...
            <li class="active">{{ $bitacora->title }}</li>
        </ol>
    </div>
</div>

<form novalidate="" class="form-horizontal form-bordered" data-parsley-validate="true"
    name="editForm" id="editForm" method="post" action="edit/{{ $bitacora->id }}/{{ $bitacora->title }}">
        ...
        <div class="col-md-7 m-t-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" name="status" id="status" value="{{ $bitacora->status }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="checkbox" name="programmed" id="programmed" <?= ($bitacora->programmed) ? "checked" : "" ?> />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group date">
                                <input type="text" name="publish_date" id="publish_date" class="form-control" value="{{ $bitacora->publish_date }}" />
                            ...
                            <div class="input-goup m-t-10">
                                ...
                                @if($bitacora->publish_status == 'Pendiente')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" name="title" placeholder="Title" value="{{ $bitacora->title }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="photo article" id="image" style="background-image: url({{ $bitacora->image }});"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Etiquetas:</label>
                        <div class="col-md-9">
                            <input type="hidden" id="tags" name="tags" placeholder="" value="<?= $bitacora->tags ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="overview" class="form-control">{{ $bitacora->overview }}</textarea>
                        </div>
                    </div>
        ...
        <div class="col-md-5 m-t-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <textarea class="ckeditor" name="article" id="article">{{ $bitacora->article }}</textarea>
                </div>
            </div>
        </div>
    </div>
