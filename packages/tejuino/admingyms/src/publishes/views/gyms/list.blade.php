    ...
    <div class="col-md-12 p-0 m-t-10">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <table id="table_gyms" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th width="30">ID</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit/{{ $gym->id }}/{{ $gym->title }}">
                                    <div class="previewImage" style="background-image: url({{ $gym->image }})"></div>
                                </a>
                            </td>
                            ...
                            <td>
                                <a href="edit/{{ $gym->id }}/{{ $gym->title }}" class="btn btn-success btn-icon btn-circle btn-sm">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="delete/{{ $gym->id }}" class="btn btn-danger btn-icon btn-circle btn-sm btnDelete">
