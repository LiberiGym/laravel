...
<div class="row">
    <div class="col-md-12 p-0">
        ...
        <ol class="breadcrumb pull-right hidden-phone">
            ...
            <li><a href="{{ $base }}">Promociones</a></li>
            <li class="active">{{ $promocion->title }}</li>
        </ol>
    </div>
</div>

<form novalidate="" class="form-horizontal form-bordered" data-parsley-validate="true"
    name="editForm" id="editForm" method="post" action="edit/{{ $promocion->id }}/{{ $promocion->title }}">
        ...
        <div class="col-md-7 m-t-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" name="status" id="status" value="{{ $promocion->status }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="checkbox" name="programmed" id="programmed" <?= ($promocion->programmed) ? "checked" : "" ?> />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group date">
                                <input type="text" name="publish_date" id="publish_date" class="form-control" value="{{ $promocion->publish_date }}" />
                                <label class="input-group-addon" for="publish_date">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </label>
                            </div>
                            <div class="input-goup m-t-10">
                                <span class="label {{ $promocion->publish_status }}">{{ $promocion->publish_status }}</span>
                                @if($promocion->publish_status == 'Pendiente')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" name="title" placeholder="Title" value="{{ $promocion->title }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="photo article" id="image" style="background-image: url({{ $promocion->image }});"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Etiquetas:</label>
                        <div class="col-md-9">
                            <input type="hidden" id="tags" name="tags" placeholder="" value="<?= $promocion->tags ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="overview" class="form-control">{{ $promocion->overview }}</textarea>
                        </div>
                    </div>
        ...
        <div class="col-md-5 m-t-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <textarea class="ckeditor" name="article" id="article">{{ $promocion->article }}</textarea>
                </div>
            </div>
        </div>
    </div>
