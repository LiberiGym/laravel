            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="checkbox" name="programmed" id="programmed" <?= ($state->programmed) ? "checked" : "" ?> />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group date">
                                <input type="text" name="publish_date" id="publish_date" class="form-control" value="{{ $state->publish_date }}" />
                                <label class="input-group-addon" for="publish_date">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </label>
                            </div>
                            <div class="input-goup m-t-10">
                                <span class="label {{ $state->publish_status }}">{{ $state->publish_status }}</span>
                                @if($state->publish_status == 'Pendiente')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="photo article" id="image" style="background-image: url({{ $state->image }});"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Etiquetas:</label>
                        <div class="col-md-9">
                            <input type="hidden" id="tags" name="tags" placeholder="" value="<?= $state->tags ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="overview" class="form-control">{{ $state->overview }}</textarea>
                        </div>
                    </div>
        ...
        <div class="col-md-5 m-t-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <textarea class="ckeditor" name="article" id="article">{{ $state->article }}</textarea>
                </div>
            </div>
        </div>
    </div>
