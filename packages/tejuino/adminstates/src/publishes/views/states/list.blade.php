    ...
    <div class="col-md-12 p-0 m-t-10">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <table id="table_states" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th width="30">ID</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit/{{ $state->id }}/{{ $state->title }}">
                                    <div class="previewImage" style="background-image: url({{ $state->image }})"></div>
                                </a>
                            </td>
                            ...
                            <td>
                                <a href="edit/{{ $state->id }}/{{ $state->title }}" class="btn btn-success btn-icon btn-circle btn-sm">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="delete/{{ $state->id }}" class="btn btn-danger btn-icon btn-circle btn-sm btnDelete">
