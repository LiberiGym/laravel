...
<div class="jarallax agileits-registro agile-section-about-detail" id="aboutUs">
    <div class="container">
        ...
        <div class="w3agile-about w3agile-about-detail">
                ...
                <ul class="nav-perfil">
                    ...
                    <li><a href="#">Reportes <span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                        <ul style="margin-left: 30px;margin-top: 25px;">
                            <li class="active"><a href="/perfil/reportes/comentarios">Comentarios <span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></li>
            ...
            <div class="col-lg-9">
                <h1>Reporte de comentarios <img src="/images/barra_amarilla_banner_top.png" height="6" style="width:79px;"/></h1>
                    ...
                    <fieldset class="col-lg-12">
                        ...
                        <table id="table_usuarios" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                @if(!is_null($gymPurcharse->qualification))
                                <tr>

                                    <td>
                                        {{  (!is_null($gymPurcharse->qualification))?$gymPurcharse->qualification->fecha:'' }}
                                    </td>
                                    <td>
                                        {{  $gymPurcharse->usuario->name.' '.$gymPurcharse->usuario->middle_name.' '.$gymPurcharse->usuario->last_name }}
                                    </td>
                                    <td>
                                        {{  (!is_null($gymPurcharse->qualification))?$gymPurcharse->qualification->comment:'' }}
                                    </td>
                                    <td>
                                        @if(!is_null($gymPurcharse->qualification))
                                            @if($gymPurcharse->qualification->calificacion==0)
                                            ...
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==0.5)
                                            <i class="fa fa-star-half-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==1)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"> </i>
                                            <i class="fa fa-star-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==1.5)
                                            <i class="fa fa-star" aria-hidden="true"style="color: #fdb429;"></i>
                                            <i class="fa fa-star-half-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==2)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==2.5)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;" ></i>
                                            <i class="fa fa-star-half-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==3)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==3.5)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;" ></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-half-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==4)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-o" aria-hidden="true"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==4.5)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star-half-o" aria-hidden="true" style="color: #fdb429;"></i>
                                            @endif
                                            @if($gymPurcharse->qualification->calificacion==5)
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;"></i>
                                            <i class="fa fa-star" aria-hidden="true" style="color: #fdb429;" ></i>
                                    ...
                                    '<table style="width:100%;">'+
                                        '<tr>'+
                                            '<td style="width:50%; text-align:center;">'+
                                                '<h3 style="font-size:18px;">Reporte de Comentarios</h3>'+
                                            '</td>'+
                                        '</tr>'+
                                    '</table>'+
                                '</div>'
